...
class ProfileLocalAPI extends BaseLocalAPI<ProfileModel>{
  ...
  ProfileLocalAPI() : super(
    ...
    params: 'id INTEGER PRIMARY KEY, name TEXT, last_name TEXT, email TEXT, contact_number INTEGER, birthday TEXT, terms_checked INTEGER, location TEXT, creation_date TEXT, last_update_date TEXT, rut INTEGER, rut_cd TEXT, district INTEGER',
    tableName: 'profile'
  );
